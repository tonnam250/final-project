...
const page = async () => {
  ...
  return (
    <div className="flex flex-col w-full h-full">
      ...
      {/* Home Section */}
      <div className="flex flex-col justify-center items-center w-full h-full min-h-screen bg-[url('/images/CowBg.jpg')] bg-cover bg-center bg-[#3D405B] bg-blend-overlay bg-opacity-80">
      ...
      {/* About section */}
      <div className="flex flex-col w-full h-full min-h-screen mt-28 items-center bg-white" id="about">
      ...
      {/* Story section */}
      <div className="flex flex-col w-full h-full min-h-screen items-center bg-[url('https://i.pinimg.com/736x/30/44/86/304486c10702352e3557a1a833a16967.jpg')] bg-no-repeat bg-cover" id="story">
        ...
        <div className="w-1/4 h-full flex flex-col justify-start bg-white bg-opacity-30">
          <h1 className="text-5xl font-bold pl-20 text-[#3D405B]">Our Story</h1>
        </div>
        <svg viewBox="0 0 1265 144" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" className="absolute bottom-10 w-full scale-y-[-1]">
          <path fill="rgba(255, 255, 255, 1)" d="M 0 40 C 164 40 164 20 328 20 L 328 20 L 328 0 L 0 0 Z" strokeWidth="0"></path>
          <path fill="rgba(255, 255, 255, 1)" d="M 327 20 C 445.5 20 445.5 89 564 89 L 564 89 L 564 0 L 327 0 Z" strokeWidth="0"></path>
          <path fill="rgba(255, 255, 255, 1)" d="M 563 89 C 724.5 89 724.5 48 886 48 L 886 48 L 886 0 L 563 0 Z" strokeWidth="0"></path>
          <path fill="rgba(255, 255, 255, 1)" d="M 885 48 C 1006.5 48 1006.5 67 1128 67 L 1128 67 L 1128 0 L 885 0 Z" strokeWidth="0"></path>
      ...
      {/* Details section */}
      <div className="flex flex-col w-full h-full min-h-screen items-center bg-[#3D405B]" id="details">
