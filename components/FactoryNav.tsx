                ...
                <div className="relative w-full md:w-auto text-center">
                    ...
                    {isDropdownOpen && (
                        <div className="absolute mt-2 w-full md:w-40 bg-white rounded-md shadow-lg left-0 md:left-auto">
                            ...
                            <Link href={'/Factory/RecieveRM'} className="block px-4 py-2 text-gray-800 text-lg hover:bg-gray-200 hover:rounded-md" onClick={closeDropdown}>Recieved Raw Milk</Link>
                        </div>
                    )}
                </div>
