    ...
    return (
        <div className="flex flex-col md:flex-row px-4 md:px-8 h-18 w-full bg-[#F5C065] items-center text-[#F8EECB] text-xl md:text-2xl font-semibold fixed z-10">
            ...
            <div className={`flex-col md:flex-row md:flex gap-4 md:gap-24 justify-end items-center w-full md:w-1/2 ${isMenuOpen ? 'flex' : 'hidden'} md:flex`}>
                <Link href={'/Retailer/GeneralInfo'} className={`hover:text-[#D23D2D] whitespace-nowrap ${pathname === "/Retail/GeneralInfo" ? "text-[#D23D2D]" : ""}`}>General Information</Link>
                <Link href={'/Retailer/Delivered'} className={`hover:text-[#D23D2D]  ${pathname === "/Retail/Delivered" ? "text-[#D23D2D]" : ""}`}>Deliver</Link>
                <Link href={'/Retailer/Recieved'} className={`hover:text-[#D23D2D] ${pathname === "/Retail/Recieved" ? "text-[#D23D2D]" : ""}`}>Recieve</Link>
                <Link href={'/Retailer/Profile'} className={`flex items-center border-2 border-[#EFE4DC] rounded-full px-2 md:px-3 py-1 md:py-2 shadow-md gap-2 md:gap-3 cursor-pointer hover:text-[#F8EECB] hover:bg-[#D23D2D]`}>
